...
export class Details extends LitElement {
    ...
    render() {
        ...
        const frontImage = "https://i.pinimg.com/474x/55/cc/0c/55cc0c5225f3024e2c13921c7691f48d.jpg";
        const backImage = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1pbB_Fs54rpBEI4xLLATn9sW5IBSpUqiF4YfsLeNMKZl7TYNsgIMXcZUyedxQLMKXkS8&usqp=CAU";

        return html`
            <section class="resumen">
                <button class="back-button" @click="${this.goBack}">←</button>
                <section class="credit-imgcard">
                    <img src="${this.showFront ? frontImage : backImage}" alt="card"
